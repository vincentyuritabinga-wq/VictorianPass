...
<script>
  ...
  function updateDisplayedPrice(){
    ...
    let price=0;
    if(amen==='Basketball Court' || amen==='Tennis Court'){ price = Math.max(1,hours) * 150; }
    else if(amen==='Clubhouse'){ price = Math.max(1,hours) * 200; }
    else { price = Math.max(1,persons) * 175; }
